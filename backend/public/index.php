...
require_once '../app/model/Child.php';
...
echo "<h2>Children:</h2>";
print_r( $childModel->getChildById('2137'));

$register = '../routes/auth.php';
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-lg-11 col-md-11">
                    <h3 class="fw-semibold mt-1">Add RHU Account</h3>
                  </div>
                </div>
                <!-- <?php
               //  $msg = Session::get("msg");
               ...
               //  }
                ?> -->
                <hr>
                <form action="http://localhost/malnutrition-monitoring-system/public/index.php?action=login" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="mb-3 col-lg-4 col-md-4">
                      ...
                      <input type="date" name="birthdate" class="form-control" id="birthdate" aria-describedby="textHelp" value="<?php echo isset($_POST['birthdate']) ? htmlspecialchars($_POST['birthdate']) : ''; ?>" required>
                    </div>
                    <div class="mb-3 col-lg-4 col-md-4">
                  ...
                  <div class="row">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6">
                      ...
                      <select class="form-select" name="municipality" aria-label="Default select example" required>
                        ...
                        <option value="Almeria" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Almeria' ? 'selected' : ''; ?>>Almeria</option>
                        <option value="Biliran" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Biliran' ? 'selected' : ''; ?>>Biliran</option>
                        <option value="Cabucgayan" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Cabucgayan' ? 'selected' : ''; ?>>Cabucgayan</option>
                        <option value="Caibiran" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Caibiran' ? 'selected' : ''; ?>>Caibiran</option>
                        <option value="Culaba" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Culaba' ? 'selected' : ''; ?>>Culaba</option>
                        <option value="Kawayan" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Kawayan' ? 'selected' : ''; ?>>Kawayan</option>
                        <option value="Maripipi" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Maripipi' ? 'selected' : ''; ?>>Maripipi</option>
                        <option value="Naval" <?php echo isset($_POST['municipality']) && $_POST['municipality'] == 'Naval' ? 'selected' : ''; ?>>Naval</option>
                      </select>
                    </div>
                  </div>
