<?php
include_once '../../backend/app/core/session.php';
Session::init();
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="#" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  ...
                  <br>
                  <br>
                  <h4 class="fw-semibold text-wrap">Rural Health Unit <span class="fw-normal">(RHU)</span></h4>
                </a>
                ...
                <div class="mb-3">
                  ...
                  <div class="text-center flex d-flex flex-row justify-content-between mb-3">
                    <div class="w-50 pe-2">
                      <button type="submit" name="btn-rhu-login" class="btn btn-primary w-100 py-8 fs-4 rounded-5">Log in</button>
                    </div>
                    <div class="w-50 ps-2">
