...
<body class="bg-light-gray">
    ...
    <div class="container-fluid">
        <div class="card">
                ...
                ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="flex d-flex flex-row justify-content-between">
                            <h5>Weight for Age: <?= $wfa; ?></h5>
                            <h5>Height for Age: <?= $hfa; ?></h5>
                            <h5>Weight for Length/Height: <?= $wfh; ?></h5>
                        </div>
                    </div>
            ...
            <div class="p-4">
                <a href="children.php" class="badge btn btn-primary rounded-3 fw-semibold">
                    <span>
