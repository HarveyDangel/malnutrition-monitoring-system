    ...
    <!-- <div class="col-md-6">
      <div class="card overflow-hidden">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-2 flex d-flex justify-content-center align-items-center m-2">
                <i class="ti ti-building-community bg-primary text-white rounded-circle p-3" style="font-size: 2.5rem;"></i>
            </div>
            <div class="col flex align-items-center m-1">
              <div>
                <h3 class="fw-semibold mb-0">
                  Province</h3>
              </div>
              <hr class="mt-0 fw-medium">
              <div>
                <h3 class="fw-normal mb-0">Biliran</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body p-3">
          <div class="row">
            ...
            <div class="col p-1 ms-2">
              ...
              <div>
                <h3 class="fw-normal"><?= $function->GetNumOfMunicipality(); ?></h3>
              </div>
            </div>
          </div>
        </div>
