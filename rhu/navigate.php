...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn-edit-child'])) {
	...
	if ($flag == 1) {
		Session::set("msg", "<div style='background-color: #9fdf9f; color:black; border: solid #ED4337  color:white;1px; border-radius: 5px; padding: 10px;'><center><i class='fa-solid fa-circle-check'></i> &nbsp Child data has been Updated! </center> </div><br>");
	} else {
		Session::set("msg", "<div style='background-color: #ED4337; color:white; border: solid #ED4337  color:white;1px; border-radius: 5px; padding: 10px;'><center><i class='fa-solid fa-circle-exclamation'></i> &nbsp Something went wrong! </center> </div><br>");
	}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn-delete-child'])) {
	...
	if (isset($_POST['child_id'])) {
		...
		if ($flag == 1) {
			Session::set("msg", "<div style='background-color: #9fdf9f; color:black; border: solid #ED4337  color:white;1px; border-radius: 5px; padding: 10px;'><center><i class='fa-solid fa-circle-check'></i> &nbsp Child data has been Deleted! </center> </div><br>");
		} else {
			Session::set("msg", "<div style='background-color: #ED4337; color:white; border: solid #ED4337  color:white;1px; border-radius: 5px; padding: 10px;'><center><i class='fa-solid fa-circle-exclamation'></i> &nbsp Something went wrong! </center> </div><br>");
		}
	} else {
