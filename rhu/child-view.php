                ...
                ?>
                    <div class="row">
                        <form method="post" action="navigate.php" class="mb-5">
                            <a href="children.php?id=<?= $_SESSION['rhu_id']; ?>" class=" btn btn-primary rounded-5 fw-semibold">
                            <i class="fa fa-arrow-left"></i> Back</a> &nbsp; &nbsp;
                            <a class=" btn btn-primary rounded-5 fw-semibold" href="child-edit.php?child_id=<?= $child_id; ?>"><i class="fa fa-edit"></i> Edit</a> &nbsp;
                            <input type="hidden" name="child_id" value="<?= $child_id; ?>">
                            <button class=" btn btn-primary rounded-5 fw-semibold float-end" type="submit" name="btn-delete-child"><i class="fa fa-trash"></i> Delete</button>
                        </form>
                    </div>
                    <div class="row">
                        <br>
                        <h3 class="fw-normal">Child Name: <span class="fw-semibold"><?= $name_of_child; ?></span></h3>
                        <hr>
                        <h5  class="fw-normal">Sex: <span class="fw-semibold"> <?= $sex; ?></span></h5>
                        <h5  class="fw-normal">Belong to IP: <span class="fw-semibold"> <?= $belong_to_ip; ?></span></h5>
                        <h5  class="fw-normal">Date of Birth: <span class="fw-semibold"> <?= $date_of_birth; ?></span></h5>
                        <h5  class="fw-normal">Name of Caregiver/Mother: <span class="fw-semibold"> <?= $name_of_caregiver; ?></span></h5>
                        <h5  class="fw-normal">Address: <span class="fw-semibold"> <?= $barangay; ?>, <?= $municipality; ?></span></h5>
                        <h5  class="fw-normal">Child ID: <span class="fw-semibold"> <?= $child_id; ?></span></h5>
                    </div>
                    <!-- <hr>
                    <div class="row ">
