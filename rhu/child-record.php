...
<!--chart(line and bar graph) need refactoring in assets/js/dashboard.js-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                if ($child) {
                    ...
                    $year = $child->year;
                ?>
                    <h1><?= $beneficiary_firstname; ?> <?= $beneficiary_lastname; ?></h1>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0"><?= $beneficiary_id; ?></h6>
                                        </td>
                                        <td class="border-bottom-0">
