...
<main class="">
    ...
    <div class="card">
        <div class="row">
            <div class="col-md-2">
                <div class="mt-3 ms-3">
                    <input type="hidden" id="municipalitySelect" value="<?= $_SESSION['municipality']; ?>">
                    <label for="barangaySelect" class="form-label">Filter by Barangay:</label>
                    <select id="barangaySelect" class="form-select mb-4 fs-2" onchange="applyFilters()">
                    ...
                    <select id="colorSelect" class="form-select mb-4 fs-2" onchange="applyFilters()">
