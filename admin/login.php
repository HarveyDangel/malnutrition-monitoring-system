              ...
              <div class="card-body">
                ...
                <form method="post" action="navigate.php">
                  ...
                  <div class="text-center flex d-flex flex-row justify-content-between mb-3">
                    <div class="w-50 pe-2">
                      <button type="submit" name="btn-admin-login" class="btn btn-primary w-100 py-8 fs-4 rounded-5">Log in</button>
                    </div>
                    <div class="w-50 ps-2">
                  ...
                  <div>
                    <a href="forget-password" class="mb-3">Forget Password?</a>
                  </div>
                </form>
              </div>
            </div>
