    ...
    <ul class="sidebar">
      ...
      <li>
        ...
        <ul class="collapse navbar-collapse flex-column" id="navbarNav">
          <li><a href="../admin/login.php"><i class="ti ti-user pe-2"></i>Admin</a></li>
          <li><a href="../doh/login.php"><i class="ti ti-user pe-2"></i>DOH</a></li>
          <li><a href="../pho/login.php"><i class="ti ti-user pe-2"></i>PHO</a></li>
          <li><a href="../rhu/login.php"><i class="ti ti-user pe-2"></i>RHU</a></li>
        </ul>
      </li>
    </ul>
    <ul class="mb-0">
      <li><a href="http://www.gov.ph/" class="fs-4"><strong>GOVPH</strong></a></li>
      <li class="hideOnMobile"><a href="index.php" class="fs-4">Home</a></li>
      ...
      <li class="hideOnMobile nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
          <li><a class="dropdown-item" href="../admin/login.php"><i class="ti ti-user pe-2"></i>Admin</a></li>
          <li><a class="dropdown-item" href="../doh/login.php"><i class="ti ti-user pe-2"></i>DOH</a></li>
          <li><a class="dropdown-item" href="../pho/login.php"><i class="ti ti-user pe-2"></i>PHO</a></li>
          <li><a class="dropdown-item" href="../rhu/login.php"><i class="ti ti-user pe-2"></i>RHU</a></li>
        </ul>
      </li>
...
<!-- style="background-image: url(../assets/images/backgrounds/gradient.jpg);" -->
  <header class="pt-5 px-4 pb-3" style="background-color:seagreen" >
